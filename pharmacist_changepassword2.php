...
if(isset($_POST["login"]))
 {
    ...
    $p1=$_POST["p1"];
    $p2=$_POST["p2"];
    $sql="SELECT * FROM (employee INNER JOIN employee_subschema ON employee.username=employee_subschema.username) WHERE  employee_subschema.username='$u' AND employee_subschema.password='$p1'AND employee.e_id='$id'";
    ...
    echo "<center><a href='DBMS5.php?emp=$id'><button>BACK</button></a><center><br><br>";
