<?php
 ...
 $link=mysqli_connect("localhost","root","") or die(my_sqli_error($link));
  ...
  $sql1="SELECT * FROM ((shop INNER JOIN shop_subschema ON shop.shop_pincode=shop_subschema.shop_pincode)INNER JOIN employee ON employee.e_id=shop.e_id) WHERE shop.shop_id='$a'";
